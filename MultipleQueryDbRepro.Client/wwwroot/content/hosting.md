...
##  [/MultipleQueryDbRepro.Client](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/MultipleQueryDbRepro.Client)
...
## [/MultipleQueryDbRepro](https://github.com/NetCoreTemplates/blazor-tailwind/tree/main/MultipleQueryDbRepro)

The .NET 6 `/MultipleQueryDbRepro` backend server is required for this App's dynamic functions including the Hello API on the home page
